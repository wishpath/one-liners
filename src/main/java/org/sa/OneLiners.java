...
public class OneLiners {
  ...
  private String qa = "DRT - Disaster Recovery Tests - process, that enables service to prepare and test support functions for the actual Disaster Recovery.\n" +
  ...
  private String containerisation = "Worker node - computing node dedicated to running the containerized applications, has its own CPU, memory, and other resources.\n" +
  ...
  private String apis = "API - Application Programming Interface - set of rules and protocols that allows different software applications to communicate.\n" +
  ...
  private String logs = "Kibana - log and data visualization and exploration tool. Used in conjunction with OpenShift (or other).\n" +
  ...
  private String esealing = "E-seal - a proof that the document has integrity (not tampered).\n" +
  ...
  private String databases = "Core - marks that database is main. But in our case there are only core databases so it's a bit meaningless, e.g. \"test_lt_core\".\n" +
  ...
  private String businessStar = "Authorized signatory - a person who can handle the company's banking matters at the bank branch.\n" +
  ...
  private String regulations = "DORA - Digital Operational Resilience Act - EU rules rules for financial institutions to manage unforeseen data disruption incidents.\n" +
  ...
  private String swedbank = "PartyMDM - centralized Party Master Data Management solution used in Swedbank Baltic. Developed by Baltic Customer Data Domain team.\n" +
  ...
  private String softwareEngineering = "ORM - Object-Relational Mapping - interaction between a database and OOP. database operations are performed using objects and classes rather than raw SQL queries. E.g.: Hibernate for Java.\n" +
  ...
  private String other = "Product backlog - prioritized list of features, enhancements, bug fixes, and other work items that need to be addressed in a product.\n" +
  ...
  private String spring = "Spring boot - part of Spring (Java framework) specific for creating web app back end.\n" +
  ...
  public String getAllOneLiners() {
    return qa + containerisation + apis + logs + esealing + databases + businessStar + regulations + swedbank + softwareEngineering + other + spring;
  }
}
